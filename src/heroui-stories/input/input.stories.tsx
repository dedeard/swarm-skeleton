...
import { CloseFilledIcon, EyeFilledIcon, EyeSlashFilledIcon, MailFilledIcon, SearchIcon } from '@heroui/shared-icons'
import { button, input } from '@heroui/theme'
import { Meta } from '@storybook/react'
import React from 'react'
import { useForm } from 'react-hook-form'

import { Input, InputProps, useInput } from '@heroui/input'
  ...
  return (
    <div className="w-full max-w-[240px]">
      <Input
        {...args}
        endContent={
          <button aria-label="show password" aria-pressed={isPasswordVisible} type="button" onClick={togglePasswordVisibility}>
            {isPasswordVisible ? (
...
const RegexValidationTemplate = (args: any) => {
...
const LabelPlacementTemplate = (args: any) => (
...
const StartContentTemplate = (args: any) => (
  <div className="flex w-full max-w-xl flex-row items-end gap-4">
    <Input
      {...args}
      // placeholder="you@example.com"
      startContent={<MailFilledIcon className="pointer-events-none flex-shrink-0 text-2xl text-default-400" />}
    />
    <Input
      {...args}
      label="Price"
...
const EndContentTemplate = (args: any) => (
  <div className="flex w-full max-w-xl flex-row items-end gap-4">
    <Input
      {...args}
...
const StartAndEndContentTemplate = (args: any) => (
  <div className="flex w-full max-w-xs flex-col items-end gap-4">
    <Input
      ...
      placeholder="heroui"
      startContent={<MailFilledIcon className="pointer-events-none flex-shrink-0 text-xl text-default-400" />}
    />
    <Input
      {...args}
      endContent={
        <div className="flex items-center">
          ...
          <select className="border-0 bg-transparent text-sm text-default-400 outline-none" id="currency" name="currency">
            <option>USD</option>
            <option>ARS</option>
            <option>EUR</option>
          </select>
...
const InputTypesTemplate = (args: any) => (
...
const CustomWithClassNamesTemplate = (args: any) => (
  <div className="w-full max-w-[340px]">
    <Input
      ...
      classNames={{
        ...
        innerWrapper: 'gap-3',
        input: ['text-base', 'text-slate-500', 'placeholder:text-slate-500', 'dark:text-slate-400', 'dark:placeholder:text-slate-400'],
      }}
      endContent={
        <div className="pointer-events-none flex items-center">
      ...
      startContent={<SearchIcon className="pointer-events-none flex-shrink-0 text-xl text-slate-400" />}
    />
  </div>
)
...
export const CustomWithHooks = {
  ...
  args: {
    ...
    startContent: <SearchIcon className="pointer-events-none mb-0.5 flex-shrink-0 text-black/50 text-slate-400 dark:text-white/90" />,
  },
}
